...
const SVCS = {
  ...
  clothes: {
    name:"Lavage & Repassage", icon:"👔", bg:"#FFF3E0", active:false, soon:"07 Avril 2026",
    fields:[
      {n:"type",l:"Type de service",t:"select",opts:["Lavage simple","Lavage & repassage","Pressing","Nettoyage à sec"]},
      {n:"quantite",l:"Quantité estimée",t:"textarea",ph:"Ex : 5 pantalons, 3 chemises..."},
      {n:"adresse",l:"Adresse de collecte",t:"text",ph:"Votre adresse à Lomé"},
      {n:"date",l:"Date de collecte souhaitée",t:"date"}
    ]
  },
  cleaning: {
  ...
  mathivick: {
    name:"Mathivick - Formation & Produits Bio", icon:"🚀", bg:"#FFF3E0", active:false, soon:"07 Avril 2026",
    fields:[
      {n:"type",l:"Type de service",t:"select",opts:["Formation commerciale en ligne","Formation commerciale en présentiel","Produits frais & bio","Formation + Produits"]},
      {n:"besoin",l:"Décrivez votre besoin",t:"textarea",ph:"Ex : Formation en prospection, Livraison de produits bio..."},
      {n:"contact",l:"Téléphone de contact",t:"tel",ph:"Ex : 90 88 88 44"},
      {n:"notes",l:"Remarques (optionnel)",t:"textarea",ph:"Précisions...",opt:true}
    ]
  },
  omega_conseil: {
    ...
    fields:[
      {n:"pack",l:"Pack souhaité",t:"select",opts:["Pack Projet Express (75 000 FCFA)","Pack Entrepreneur Pro (150 000 FCFA)","Pack Stratégique Premium (250 000 FCFA)","Service additionnel","Diagnostic gratuit"]},
      {n:"projet",l:"Description du projet",t:"textarea",ph:"Décrivez votre projet à financer..."},
      {n:"contact",l:"Téléphone de contact",t:"tel",ph:"Votre numéro"},
      {n:"notes",l:"Remarques (optionnel)",t:"textarea",ph:"Précisions...",opt:true}
    ]
  },
  immobilier: {
    ...
    fields:[
      {n:"prestation",l:"Type de prestation",t:"select",opts:["Location de biens","Vente & Acquisition","Gestion locative","Assistance Immobilière Diaspora"]},
      {n:"typeBien",l:"Type de bien",t:"select",opts:["Appartement","Villa","Bureau","Espace commercial","Entrepôt","Terrain"]},
      {n:"budget",l:"Budget estimatif (FCFA)",t:"number",ph:"Ex : 50000000"},
      {n:"zone",l:"Zone souhaitée",t:"text",ph:"Ex : Lomé, Tokoin..."},
      {n:"delai",l:"Délai",t:"text",ph:"Ex : Urgent, 3 mois..."},
      {n:"details",l:"Détails supplémentaires",t:"textarea",ph:"Décrivez vos besoins..."},
      {n:"contact",l:"Téléphone de contact",t:"tel",ph:"Votre numéro"}
    ]
  },
