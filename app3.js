...
const PACKS_SERVICES = ['mathivick', 'omega_conseil', 'immobilier']; // services avec packs
...
function openService(id) {
  ...
  // ── Cas spécial : services avec système de packs (Mathivick, Omega Conseils, Immobilier) ──
  if (PACKS_SERVICES.includes(id)) {
    ...
    const sectionTitles = {
      ...
      'immobilier': '🏢 Nos prestations immobilières'
    };
    const titleEl = document.getElementById('kits-section-title');
...
const DEFAULT_KITS = [
  ...
  {
    id:'math3', nom:'Produits Frais & Bio', emoji:'🥬', service:'mathivick',
    description:'Produits frais et biologiques de qualité pour une alimentation saine',
    prix_total:0, categorie:'Mathivick - Produits Bio',
    articles:[
      {name:'Légumes bio du jour', qty:1, unit:'panier', emoji:'🥕'},
      {name:'Fruits de saison', qty:1, unit:'panier', emoji:'🍎'},
      {name:'Produits locaux', qty:1, unit:'sélection', emoji:'🌾'},
      {name:'Livraison à domicile', qty:1, unit:'service', emoji:'🚚'},
    ],
    contact:'90 88 88 44'
  },
  {
    id:'math4', nom:'Pack Formation + Produits', emoji:'🚀', service:'mathivick',
    description:'Formez-vous et recevez des produits frais & bio régulièrement',
    prix_total:0, categorie:'Mathivick - Combiné',
    articles:[
      {name:'Formation commerciale complète', qty:1, unit:'programme', emoji:'🎓'},
      {name:'Livraison produits bio mensuelle', qty:3, unit:'mois', emoji:'📦'},
      {name:'Suivi personnalisé', qty:1, unit:'accompagnement', emoji:'👨‍🏫'},
    ],
    contact:'90 88 88 44'
  },
...
async function loadKitsList(serviceFilter = null) {
...
function renderKitCard(k) {
  ...
  const catColor = {
    ...
    'Mathivick - Formation':'#FFF3E0','Mathivick - Produits Bio':'#E8F5E9','Mathivick - Combiné':'#FFF9E6',
